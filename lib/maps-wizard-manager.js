...
class MapsWizardManager
{
    ...
    async generateMaps(req, res)
    {
        ...
        if(!selectedHandler || 'string' !== typeof selectedHandler){
        ...
        if('string' === typeof generatorData && this.maxJsonSize < generatorData.length){
            return this.mapsWizardRedirect(res, 'mapsWizardDataTooLargeError');
        }
        let mapData;
        try {
            if('string' === typeof generatorData){
